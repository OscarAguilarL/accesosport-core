 ...
 * @param contactName      The name of the contact person. Must not be blank and can have a maximum length of 120 characters.
 * @param phone            The phone number of the contact. Must not be blank and must have a length between 7 and 15 characters.
 * @param address          The address details of the organization. Must not be null.
